                ...
                var        defaults = {
                        ...
                        flake = function(_x, _y, _size, _speed, _id)
                        {
                                ...
                                this.update = function(){
                                        ...
                                        if(this.y > (elTop + elHeight) - (this.size - 2) || this.x <= elLeft || this.x >= elLeft + elWidth - 1){
                                                this.reset();
                                        }
                ...
                return{
                        snow : function(_element, _options){
                                ...
                                for(i = 0; i < defaults.flakeCount; i+=1){
										...
										random((defaults.minSize * 100), (defaults.maxSize * 100)) / 100,
										random(defaults.minSpeed, defaults.maxSpeed), flakeId));
                                }
                                // start the snow
                                animateSnow();
                        },
